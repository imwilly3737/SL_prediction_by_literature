...
public class ExtractAbstracts {
	public static void main(String args[]) {
		...
		try{
			...
			String urlStr = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&term="+urlp.queryWord+"+AND+"+urlp.organism+"[Organism]&retmax="+urlp.retMax+"&retstart="+urlp.retStart;
