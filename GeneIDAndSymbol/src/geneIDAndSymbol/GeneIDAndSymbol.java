...
public class GeneIDAndSymbol {
	...
	public static void main(String args[]) throws ClassNotFoundException, SQLException{
		GeneIDAndSymbol gias= new GeneIDAndSymbol();
		System.out.println(gias.getIDbySymbol("tp53"));
		
		gias = new GeneIDAndSymbol(true);
		System.out.println(gias.getSymbolbyID("123456789"));
	}
}
