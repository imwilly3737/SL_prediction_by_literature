...
public class EssentialGeneMultiCancer {
	List<String> diseases;
	List<TriggerTermRanking> ttrs;
	String OutFile;
	HashMap<String,Double> eTrigger;
	public EssentialGeneMultiCancer(List<String> ids) throws IOException {
		diseases = ids;
	...
	static public void main(String[] args) throws IOException{
		...
		EssentialGeneMultiCancer egmc = new EssentialGeneMultiCancer(ids);
